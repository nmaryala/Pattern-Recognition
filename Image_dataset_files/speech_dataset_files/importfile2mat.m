function sa1 = importfile2mat(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   SA1 = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   SA1 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   sa1 = importfile('sa1', 2, 319);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/10/11 13:23:27
